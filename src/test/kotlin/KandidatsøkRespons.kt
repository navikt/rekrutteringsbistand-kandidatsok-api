...
object KandidatsøkRespons {
    ...
    val innsatsgruppeTermMedSpesieltOgSituasjonsbestemtInnsats = """{"terms":{"innsatsgruppe.keyword":["SPESIELT_TILPASSET_INNSATS","SITUASJONSBESTEMT_INNSATS"]}}"""
    val innsatsgruppeTermMedIkkeVurdert = """{"terms":{"innsatsgruppe.keyword":["HAR_IKKE_GJELDENDE_14A_VEDTAK"]}}"""
    val innsatsgruppeTermMedGradertVarigTilpasset = """{"terms":{"innsatsgruppe.keyword":["GRADERT_VARIG_TILPASSET_INNSATS"]}}"""
    val innsatsgruppeTermMedAlle = """{"terms":{"innsatsgruppe.keyword":["HAR_IKKE_GJELDENDE_14A_VEDTAK","SPESIELT_TILPASSET_INNSATS","SITUASJONSBESTEMT_INNSATS","STANDARD_INNSATS","VARIG_TILPASSET_INNSATS","GRADERT_VARIG_TILPASSET_INNSATS"]}}"""
    ...
    val hovedmålTerm = """{"terms":{"hovedmal.keyword":["SKAFFE_ARBEID","OKE_DELTAKELSE"]}}"""
