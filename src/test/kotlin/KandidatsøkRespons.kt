...
object KandidatsøkRespons {
    ...
    val innsatsgruppeTermMedGradertVarigTilpasset = """{"terms":{"innsatsgruppe":["GRADERT_VARIG_TILPASSET_INNSATS"]}}"""
    ...
    val valgtKontorTerm = """{"bool":{"should":[{"term":{"orgenhet":{"value":"0403"}}},{"term":{"orgenhet":{"value":"1001"}}}]}}"""
