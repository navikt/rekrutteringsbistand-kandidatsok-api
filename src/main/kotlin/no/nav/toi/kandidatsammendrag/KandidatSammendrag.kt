...
@OpenApiName("KandidatSammendragRequestDto")
...
fun JavalinDefaultRoutingApi.handleKandidatSammendrag(openSearchClient: OpenSearchClient, modiaKlient: ModiaKlient) {
    post(endepunkt) { ctx ->
