...
fun JavalinDefaultRoutingApi.handleLookupPerson(openSearchClient: OpenSearchClient) {
    post(endepunkt, handleLookupPersonFraOpensearch(openSearchClient))
}
...
fun handleLookupPersonFraOpensearch(openSearchClient: OpenSearchClient): (Context) -> Unit = { ctx ->
